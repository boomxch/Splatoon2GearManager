...
(function( $ ){
  ...
  var methods = {
      init: function(options){
          ...
          dropdown.css('z-index',options.z).css('background-color','#e4e4e4').css('border','1px solid ' + options.borderColor);
          dropdown.hide();
      ...
      update:function(options){
          ...
          // $("select[name=" + selectName + "]").change(); // infinite loop
          updateDataDisplay(); // 構造が好きじゃない 本当はselects.jsからsplatData.jsにつなげたかった
